...
Test The main purpose of this fork, other than cosmetic changes, is to create a web representation of an [[Obsidian::https://obsidian.md]] vault, using the [[Simply-Jekyll::https://github.com/raghuveerdotnet/simply-jekyll]] template.
...
This will allow you to modify all your markdown files inside the directory.  Can it do #tagging correctly?
...
![](../assets/img/fork_button%201.jpg)
